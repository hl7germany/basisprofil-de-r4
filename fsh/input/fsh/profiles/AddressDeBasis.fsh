...
* line ..3
  ...
  * ^example._valueString.extension[0].url = "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-streetName"
  * ^example._valueString.extension[=].valueString = "Musterweg"
  * ^example._valueString.extension[+].url = "http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-houseNumber"
  * ^example._valueString.extension[=].valueString = "42"
