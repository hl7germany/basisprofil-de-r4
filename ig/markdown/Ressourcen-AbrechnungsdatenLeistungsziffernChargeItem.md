...
In FHIR werden Abrechnungsleistungen in Form von [ChargeItem](http://hl7.org/fhir/r4/chargeitem.html)-Ressourcen abgebildet.
Diese können in [Accounts](http://hl7.org/fhir/r4/account.html) aggregiert und schließlich zu einer [Invoice](http://hl7.org/fhir/r4/invoice.html) oder einem [Claim](http://hl7.org/fhir/claim.html) verarbeitet werden.

Während ChargeItem die *Instanz* einer zu einem konkreten Zeitpunkt für einen konkreten Patienten erbrachten Leisung darstellt, werden in [ChargeItemDefinition](http://hl7.org/fhir/r4/chargeitemdefinition.html) die Eigenschaften (z.B. Preis, Anwendbarkeit, Zu-/Abschläge) der Ziffern eines Leistungskataloges abgebildet. 
